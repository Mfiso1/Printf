...
/**
 * print_char - Helper function to print a single character and update the count
...
/**
 * print_string - Helper function to print a null-terminated string and update the count
 ...
 *
 * Return: The number of printed characters without the null byte
 */
